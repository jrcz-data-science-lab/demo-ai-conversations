...
if __name__ == '__main__':
    ...
    parser.add_argument('--chunk_size', type=int, default=4096,
                        help="Audio chunk size in frames. Smaller values (e.g., 2048 or 1024) "
                             "can reduce latency but increase network/CPU overhead. (Default: 4096)")
    ...
    if args.files:
        ...
        # Create a new client FOR EACH file, as the client closes
        # its connection after processing one file.
        for f in valid_files:
            ...
            client(f)
            time.sleep(1) # Delay between files
    else:
        # No files provided, use microphone input
